...
public class Topology {
	...
	private static final String HASHTAG_LOG = "/s/bach/d/under/ravno/cs535P2/P2/hashtag-log";
	private static final String NAMEDENT_LOG = "/s/bach/d/under/ravno/cs535P2/P2/namedent-log";
	...
	public static void main(String[] args){
		...
		// counter bolt
		builder.setBolt("hashtag-counter-bolt", new CounterBolt(BUCKET_WIDTH, THRESHOLD, TIME_INTERVAL), 1).fieldsGrouping("reader-bolt", "hashtag-stream", new Fields("entry"));
		builder.setBolt("namedent-counter-bolt", new CounterBolt(BUCKET_WIDTH, THRESHOLD, TIME_INTERVAL), 1).fieldsGrouping("reader-bolt", "namedent-stream", new Fields("entry"));
